    ...
    <div className="flex flex-col items-center justify-center min-h-screen bg-cover bg-center"
      ...
      <div className="flex items-center justify-center w-full">
        <button onClick={() => { alert('Vote enregistré pour la première image!'); }}
                className="mx-2">
          <img src="/Jude.jpg" alt="Première Image" className="w-96 h-96 shadow-lg hover:shadow-xl transition-shadow duration-300" />
        </button>
        <button onClick={() => { alert('Vote enregistré pour la deuxième image!'); }}
                className="mx-2">
          <img src="Vini.jpg" alt="Deuxième Image" className="w-96 h-96 shadow-lg hover:shadow-xl transition-shadow duration-300" />
        </button>
      </div>
    </div>
  );
